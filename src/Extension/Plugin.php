...
namespace Webmasterskaya\Plugin\System\YandexMetrika\Extension;
...
class Plugin extends CMSPlugin implements SubscriberInterface, DatabaseAwareInterface
{
     ...
     * @since  1.0.0
     */
    private ?bool $_isAuthorizedAdmin = null;
